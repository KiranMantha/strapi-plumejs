...
export interface ApiAboutAbout extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    heroBanner: Schema.Attribute.Component<'components.hero-banner', false>;
    richText: Schema.Attribute.Component<'components.rich-text', false>;
    createdAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    publishedAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> & Schema.Attribute.Private;
...
export interface ApiHomeHome extends Struct.SingleTypeSchema {
  ...
  attributes: {
    heroBanner: Schema.Attribute.Component<'components.hero-banner', false>;
    duplex: Schema.Attribute.Component<'components.duplex', true>;
    quote: Schema.Attribute.Component<'components.quote', false>;
    title: Schema.Attribute.String;
    createdAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    publishedAt: Schema.Attribute.DateTime;
