var x=Object.defineProperty;var c=(r,e,s)=>e in r?x(r,e,{enumerable:!0,configurable:!0,writable:!0,value:s}):r[e]=s;var l=(r,e,s)=>c(r,typeof e!="symbol"?e+"":e,s);import{h as d,f,b as v,p as g}from"./index-DUgFqLgN.js";var h=Object.defineProperty,u=Object.getOwnPropertyDescriptor,n=(r,e,s,t)=>{for(var p=t>1?void 0:t?u(e,s):e,i=r.length-1,a;i>=0;i--)(a=r[i])&&(p=(t?a(e,s,p):a(p))||p);return t&&p&&h(e,s,p),p};let o=class{constructor(){l(this,"props",d())}render(){if(this.props()){const{heading:r,description:e,image:s,imagePosition:t}=this.props();return f` <div class="container mx-auto duplex-container ${t==="left"?"":"reverse"}">
